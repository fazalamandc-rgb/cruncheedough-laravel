...
<body bgcolor="#3399CC">
<br><br>
<form name="frm" action="{{ url('proclog') }}" method="post" onsubmit="return validate_form();">
    ...
    <div align="center">
        ...
        <table width="546" bgcolor="#006699" align="center" border="1">
            ...
            <tr> 
                <td height="61"><font color="gray">Email/Cell No:</font></td>
            ...
            <tr>
                <td>
                    ...
                    <a href="{{ route('admlogin') }}">Admin Panel</a>
                </td>
